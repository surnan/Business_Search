...
extension UIColor {
    ...
    static let darkOrange = UIColor(red: 250/255, green: 98/255, blue: 21/255, alpha: 1)
    ...
    static let ghostWhite = UIColor(red: 248/255, green: 248/255, blue: 255/255, alpha: 1)
