...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        //let appCoordinator = AppCoordinator(window: window, dataController: dataController, navigationVC: navigationVC)
        
        let appCoordinator  = AppCoordinator(window: <#T##UIWindow?#>, dataController: <#T##DataController#>)
