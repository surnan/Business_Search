...
extension SearchByAddressController {
    func setupUI(){
        ...
        //myTextView.frame.size = myTextView.contentSize
    ...
    func updateBarButton() -> UIBarButtonItem{
         return UIBarButtonItem(title: "Next", style: .done, target: self, action: #selector(handleRightBarButton))
