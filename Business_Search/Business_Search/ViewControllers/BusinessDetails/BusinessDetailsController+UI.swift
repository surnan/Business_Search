...
extension BusinessDetailsController {
    ...
    func setupUI(){
        ...
        let infoStack   = mainView.getFullStack()
        [mainView.mapView, mainView.nameLabel, infoStack, buttonStack].forEach{view.addSubview($0)}
        ...
        mainView.nameLabel.anchor(top: mainView.mapView.bottomAnchor,
                                  padding: .init(top: 10, left: 0, bottom: 0, right: 0),
                                  centerX: true, x: view.widthAnchor, xMultiply: 0.8)
        infoStack.anchor(top: mainView.nameLabel.bottomAnchor, padding: .init(top: 15, left: 0, bottom: 0, right: 0), centerX: true)
